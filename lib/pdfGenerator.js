      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .totals-left { flex: 1; padding: 6px; border-right: 2px solid #000; border-left: 2px solid #000; }
          .totals-right { width: 220px; padding: 6px; border-right: 2px solid #000; }
          ...
          .amount-words { padding: 6px; border-top: 2px solid #000; border-left: 2px solid #000; border-right: 2px solid #000; font-size: 7px; font-weight: bold; }
