...
productSchema.pre('save', function(next) {
  if (!this.purchasePrice && this.stockPurchaseValue && this.stock > 0) {
    this.purchasePrice = this.stockPurchaseValue / this.stock;
  } else if (!this.purchasePrice) {
    this.purchasePrice = this.sellingPrice * 0.8;
  }
