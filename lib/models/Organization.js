...
const organizationSchema = new mongoose.Schema({
  ...
  settings: {
    ...
    categories: { type: [String], default: ['Tiles', 'Sanitary', 'WPC Doors', 'Accessories'] },
    ...
    whatsapp: { type: mongoose.Schema.Types.Mixed },
    googleDrive: { type: mongoose.Schema.Types.Mixed },
